...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 05 Agu 2022 pada 05.39
...
(25, 44, '1024px-WhatsApp.svg.png', 'artefak/7hwGSBXZYqDzBoRpLa4tBAhQABEmYMvDP9kwPRcy.png');
...
--
ALTER TABLE `artefak_project`
  MODIFY `id_artefak` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=46;
...
--
ALTER TABLE `versi`
  MODIFY `id_versi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
