...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 02 Agu 2022 pada 02.56
...
(1, 2, 1, 'File', 'Mencoba File lama', 2),
(2, 2, 1, 'coba2', '', 3),
...
(33, 2, 1, 'lagi', '', 2),
(34, 2, 1, 'tambah laggi', '', 2),
(35, 2, 1, 'tambah lagi', '', 2),
(36, 30, 1, 'aku', '', 2),
(37, 30, 1, 'aminrois', '', 2);
...
(17, 1, 'laravel (3).sql', 'artefak/u9JsuWWiTiH303LAqrPoVhwrkBJGmSJZGalFFMTa.txt'),
(18, 35, '283391487_701684221087777_6780107235581148553_n.jpg', 'artefak/96QnGgxyGF4lnXLBPlUvpEQv1eQB6XqhXcNpsah4.jpeg'),
(19, 35, '283150544_2182132945286370_2726308724572611817_n.jpg', 'artefak/Z8Ea53dqkrVvccjeBGlcBwISUzl4b0ND5X43lP2d.jpeg'),
...
--
ALTER TABLE `artefak_project`
  MODIFY `id_artefak` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;
...
--
ALTER TABLE `berkas`
  MODIFY `id_berkas` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
